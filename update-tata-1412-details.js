...
async function updateTruckDetails() {
  console.log('🔄 Updating details for Tata 1412 LPT...\n')
  ...
  try {
    ...
    const updateData = {
      model: '1412G LPT DCR42CBC125B6M5',
      year: 2021,
      kilometers: 195466, // 1,95,466 km
      horsepower: 125,
      price: 1340000, // 13.40 Lakhs (already updated, but including for completeness)
      location: 'Sonipat',
      state: 'Haryana',
      city: 'Sonipat',
      subtitle: 'CNG • Manual • 1st Owner • 1,95,466 km'
    }
    ...
    console.log('   Insurance: 05/05/26')
    console.log('   Gearbox: 5 forward, 1 reverse')
    console.log('   RTO: SONIPAT')
