// Script to upload all ASHOK LEYLAND ECOMET STAR 1615 HE images to Supabase Storage
...
const TRUCK_FOLDER_NAME = 'ASHOK_LEYLAND_ECOMET_STAR_1615_HE'
...
async function uploadAllImages() {
  console.log('🚀 Starting to upload ASHOK LEYLAND ECOMET STAR 1615 HE images to Supabase...\n')
  ...
  // Save mapping file
  const mappingFile = path.join(__dirname, 'ashok-leyland-1615-image-mapping.json')
