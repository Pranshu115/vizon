// Script to check if the Mahindra Bolero Maxitruck Plus exists in the database
...
async function checkTruck() {
  console.log('🔍 Checking for Mahindra Bolero Maxitruck Plus in database...\n')
  ...
  try {
    ...
    if (data) {
      ...
      console.log('\n✅ All 15 images are uploaded to Supabase Storage!')
