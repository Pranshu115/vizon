...
async function updateTruckDetails() {
  console.log('🔄 Updating details for ASHOK LEYLAND ECOMET STAR 1615 HE...\n')
  ...
  try {
    ...
    const updateData = {
      model: 'CA1615/47 HCC G',
      year: 2022, // 03/2022
      kilometers: 254037, // 2,54,037 km
      horsepower: 143, // 142.71 HP (rounded to integer)
      price: 1600000, // ₹16.00 Lakh
      location: 'Ghaziabad',
      state: 'Uttar Pradesh',
      city: 'Ghaziabad',
      subtitle: 'CNG • Manual • 1st Owner • 2,54,037 km • 22ft Payload'
    }
