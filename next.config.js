...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'ccmlkidiwxmqxzexoeji.supabase.co',
        pathname: '/storage/v1/object/public/**',
      },
    ],
    // Allow unoptimized images for external sources to avoid production issues
    unoptimized: false,
    // Enable image optimization but allow external sources
