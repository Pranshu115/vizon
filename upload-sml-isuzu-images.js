// Script to upload all SML Isuzu Samrat 4760gs images to Supabase Storage
...
const TRUCK_FOLDER_NAME = 'SML_ISUZU_SAMRAT_4760GS'
...
async function uploadAllImages() {
  console.log('🚀 Starting to upload SML Isuzu Samrat 4760gs images to Supabase...\n')
  ...
  // Save mapping file
  const mappingFile = path.join(__dirname, 'sml-isuzu-image-mapping.json')
