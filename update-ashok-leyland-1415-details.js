...
async function updateTruckDetails() {
  console.log('🔄 Updating details for ASHOK LEYLAND ECOMET STAR 1415 HE...\n')
  ...
  try {
    ...
    const updateData = {
      ...
      year: 2022, // 03/2022
      kilometers: 236133, // 2,36,133 km
      horsepower: 143, // 142.71 HP (rounded to integer)
      price: 1500000, // ₹15.00 Lakhs
      location: 'Ghaziabad',
      state: 'Uttar Pradesh',
      city: 'Ghaziabad',
      subtitle: 'CNG • Manual • 1st Owner • 2,36,133 km'
    }
    ...
    console.log('   Insurance: 01/01/27')
