// Script to check if the ASHOK LEYLAND ECOMET STAR 1615 HE exists in the database
...
async function checkTruck() {
  console.log('🔍 Checking for ASHOK LEYLAND ECOMET STAR 1615 HE in database...\n')
  ...
  try {
    ...
    if (data) {
      ...
      console.log('\n✅ All 17 images are uploaded to Supabase Storage!')
      console.log('   They will display in the truck details page gallery.\n')
    }
  } catch (error) {
