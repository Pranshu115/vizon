// Script to upload Eicher Pro 1075 F HSD truck to Supabase
...
let mainImageUrl = '/trucks/eicher-pro-1075-f-hsd.jpg' // Fallback
try {
...
const truckData = {
  name: 'EICHER PRO 1075 F HSD',
  manufacturer: 'Eicher Motors',
  model: 'Pro 1075 F HSD',
  ...
  price: 700000, // Default - update with actual price (₹7 Lakhs)
  image_url: mainImageUrl,
  subtitle: 'Efficient and reliable commercial truck',
  certified: true,
...
async function uploadTruck() {
  console.log('🚀 Starting to upload EICHER PRO 1075 F HSD to Supabase...\n')
