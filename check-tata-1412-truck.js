// Script to check if the Tata 1412 LPT exists in the database
...
async function checkTruck() {
  console.log('🔍 Checking for Tata 1412 LPT in database...\n')
  ...
  try {
    ...
    if (data) {
      ...
      console.log('\n✅ All 30 images are uploaded to Supabase Storage!')
