// Script to upload all Mahindra Bolero Maxitruck Plus images to Supabase Storage
...
const TRUCK_FOLDER_NAME = 'MAHINDRA_BOLERO_MAXITRUCK_PLUS'
...
async function uploadAllImages() {
  console.log('🚀 Starting to upload Mahindra Bolero Maxitruck Plus images to Supabase...\n')
  ...
  // Save mapping file
  const mappingFile = path.join(__dirname, 'mahindra-bolero-image-mapping.json')
