// Script to upload all Tata 609g images to Supabase Storage
...
const TRUCK_FOLDER_NAME = 'TATA_609G' // Storage folder name in Supabase
...
const findSourceFolder = () => {
  ...
  return path.join(__dirname, 'Tata 609g ')
}
...
async function updateTruckWithImages(imageUrls) {
  try {
    // Get the truck ID - using exact name "Tata 609g"
...
async function uploadAllMedia() {
  console.log('🚀 Starting to upload Tata 609g images to Supabase...\n')
  ...
  if (!fs.existsSync(SOURCE_FOLDER)) {
    ...
    console.error(`   Please make sure the folder "Tata 609g" exists in the project root`)
    process.exit(1)
  }
