// Script to upload all PDF reports for Tata 1109g LPT
...
const TRUCK_FOLDER_NAME = 'TATA_1109G_LPT/REPORTS'
const SOURCE_FOLDER = path.join(__dirname, 'Tata 1109g LPT')

// Report files to upload - these are the actual filenames in the folder
const REPORT_FILES = [
  'Legal Report HR55AP0795.pdf',
  'VEHICLE INSPECTION REPORT HR55AP0795.pdf',
  'WEB REPORT HR55AP0795.pdf'
]
...
async function uploadAllReports() {
  console.log('🚀 Starting to upload Tata 1109g LPT reports to Supabase...\n')
