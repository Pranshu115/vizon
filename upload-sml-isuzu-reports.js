// Script to upload all PDF reports for SML Isuzu Samrat 4760gs
...
const TRUCK_FOLDER_NAME = 'SML_ISUZU_SAMRAT_4760GS/REPORTS'
const SOURCE_FOLDER = path.join(__dirname, 'SML Isuzu Samrat 4760gs')

// Report files to upload
const REPORT_FILES = [
  'Copy of Legal Report DL1MA9541.pdf',
  'Copy of VEHICLE INSPECTION REPORT DL1MA9541.pdf',
  'WEB REPORT DL1MA9541.pdf'
]
...
async function uploadAllReports() {
  console.log('🚀 Starting to upload SML Isuzu Samrat 4760gs reports to Supabase...\n')
  ...
  // Save mapping file
  const mappingFile = path.join(__dirname, 'sml-isuzu-reports-mapping.json')
