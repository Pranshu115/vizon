// Script to check if the SML Isuzu Samrat 4760gs exists in the database
...
async function checkTruck() {
  console.log('🔍 Checking for SML Isuzu Samrat 4760gs in database...\n')
  ...
  try {
    ...
    if (data) {
      ...
      console.log('\n✅ All 23 images are uploaded to Supabase Storage!')
